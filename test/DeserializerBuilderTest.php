...
class DeserializerBuilderTest extends TestCase
{
    public function buildProvider(): array
    {
        return [
            ...
            ['{"version":"V1"}', "\AgDevelop\ObjectMirror\Deserializer\V1\Deserializer"],
            ['{"version":"V0.123-alfa"}', new DeserializerException('Unsupported serializer version for given JSON data at version V0.123-alfa')],
            [["version" => "V1"], "\AgDevelop\ObjectMirror\Deserializer\V1\Deserializer"],
            [(object)["version" => "V1"], "\AgDevelop\ObjectMirror\Deserializer\V1\Deserializer"],
        ];
    }
     ...
     */
    public function testBuild($json, $expected)
    {
